...
import { Friend, Colleague, SecureFriendContact, FriendPartial, EventPass, intersectionFriend } from "./myTypes";
...
function secureFindFriends(friends: Friend[], criteria: (f: Friend) => boolean): SecureFriendContact[] {
  ...
  function intersection(friends: Friend[], colleagues: Colleague[]): intersectionFriend[] {
    let result: intersectionFriend[] = []
